# src/99_run_all.R
# Purpose: Run full CT04 analysis pipeline and verify QC completion
...
qc_files_expected <- c(
  file.path(PATHS$results, "QC_00_make_data.txt"),
...
message("\n================ FINAL QC SUMMARY ================")
message("✔ Make-data QC completed (00_make_data)")
