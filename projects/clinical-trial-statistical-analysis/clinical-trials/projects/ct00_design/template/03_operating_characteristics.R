# ct00_design/03_operating_characteristics.R
# Purpose:
# Evaluate operating characteristics across multiple scenarios:
# - type I error
# - power
# - bias
# - CI coverage
#
# Outputs:
# - results/ct00_design/operating_characteristics.csv
...
scenario_grid <- expand.grid(
  p_control = c(0.20, 0.30, 0.40),
  treatment_effect = c(0.00, 0.05, 0.10, 0.15)
)
