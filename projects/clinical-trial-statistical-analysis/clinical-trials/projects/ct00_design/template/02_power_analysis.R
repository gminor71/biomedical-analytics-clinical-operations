# ct00_design/02_power_analysis.R
# Purpose:
# Perform analytical power and sample size calculations
# for a two-arm trial with a binary endpoint.
#
# Outputs:
# - results/ct00_design/power_curve.csv
# - results/ct00_design/power_curve.png
# - console summary of required sample size
...
plot(
  ...
  ylab = "Power",
  main = "Analytical Power Curve: Two-Arm Binary Endpoint Trial"
)
